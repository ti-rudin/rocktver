...
<div class="w-full  ">
	...
	>
		<div class="flex items-center border-b border-gray-500 pb-3 dark:border-gray-200">
		...
		<div class="px-2">
			<div tabindex="0" class="mt-1 flex flex-col focus:outline-none">
				...
				<div class="mt-3 px-4 pt-2  text-center text-lg leading-3 text-black dark:text-white">
	...
	<div class="mt-5 w-full ">
		...
		>
			<a
				...
				href={'/band/' + concert.attributes.zhuri.data.attributes.band_name}
			>
				<img
					class=" h-28 w-28 w-full rounded shadow"
					src={'https://admin.rocktver.ru' +
						concert.attributes.zhuri.data.attributes.group_logo.data.attributes.url}
					alt=""
				/>
				<div>
